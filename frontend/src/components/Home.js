    ...
    <main className="mt-4">
      <div className="container">
        {/* <h1 className="text-center">
          Academia <span Style={"color:purple"}>#1</span> de Nicaragua
        </h1> */}
        {/* latest course section */}
        <h3 className="mt-4" Style={"font-family:neue"}>
          {" "}
          Latest Course{" "}
          <Link
            to="/course/python-timer/123"
...
>>>>>>> Stashed changes
        <div className="row mb-4">
          ...
          <h3 className="mb-4" Style={"font-family:neue"}>
            Popular categories
            <a href="#" className="float-end btn btn-warning">
              {"  "}
          ...
          <h3 className="mb-4" Style={"font-family:neue"}>
            ...
            <a href="#" className="float-end btn btn-warning">
              {" "}
              View instructor <i className="fa-solid fa-arrow-right-long"></i>
            </a>
          </h3>
          <div className="row">
            {/* instructor Box */}
                ...
                <div className="card-body">
                  ...
                  <div className="card-footer">
                    ...
                    <button
                      ...
                      className="btn btn-primary btn-sm-2 ms-2"
                    >
                      {" "}
              ...
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <div className="card-footer">
                    ...
                    <button
                      title="Agregar medalla"
                      className="btn btn-warning btn-sm-2 ms-2"
                    >
                      {" "}
                      <i className="fa fa-medal"></i>
                    </button>
